...
\begin{figure}[ht]
    ...
    \caption{Conceptual illustration of gradient distributions. Standard BPR (left): most samples cluster near zero gradient. HardBPR (right): semantic reweighting amplifies gradients for semantically challenging pairs, producing a more uniform distribution.}
    \label{fig:grad}
\end{figure}
